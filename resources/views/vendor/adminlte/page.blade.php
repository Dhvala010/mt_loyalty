                ...
                <div class="navbar-custom-menu">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <form id="logout-form" action="{{ route(config('adminlte.logout_route', 'admin.logout')) }}" method="POST" style="display: none;">
                                {{ csrf_field() }}
                            </form>
                        </li>
...
<span>Offers</span></a>
                    ...
                    @endif
                    @if(Auth::user()->role == 1 || Auth::user()->role == 3)
                    <li {{ (Request::segment(1) === 'admin' && Request::segment(2) === 'reward' &&  empty(Request::segment(3))) ? 'class=active' : null }}>
                        <a href="{{URL::to('admin/reward')}}"><i class="fa fa-gift" aria-hidden="true"></i>
